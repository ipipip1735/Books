            ...
            <div class="panel-body">
                <table class="table text-center">
                    ...
                    if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) {
                        ...
                        $where = "(retext LIKE '%mb%') AND (lyid LIKE '$like' OR name LIKE '$like' OR email LIKE '$like' OR mycall LIKE '$like' OR lytime LIKE '$like' OR lytext LIKE '$like')";
                        $r = $page->pageContentFree($pageNum, $where);
                    } else {
                        $project = array("retext||LIKE" => "%mb%");
                    ...
                    <ul class="pagination">
                        ...
                        if (($n = $pageNum - 1) < 1) {
                            ...
                            if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) {
                                ...
                                echo "<li>
                                                    <a href=\"?location=showBooks&pageNum=$n&search=" . $_REQUEST['search'] . "\" aria-label=\"Previous\">
                                                        <span aria-hidden=\"true\">&laquo;</span>
                                                    </a>
                                                </li>";
                            } else {
                        ...
                        for ($i = 1; $i <= $page->pageTotal; $i++) {
                            if ($i == $pageNum) {
                                ...
                                if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) {
                                    echo "<li><a href=\"?location=showBooks&pageNum=$i&search=" . $_REQUEST['search'] . "\">$i</a></li>";
                                } else {
                        ...
                        if (($n = $pageNum + 1) > $page->pageTotal) {
                            ...
                            if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) {
                                ...
                                echo "<li>
                                                    <a href=\"?location=showBooks&pageNum=$n&search=" . $_REQUEST['search'] . "\" aria-label=\"Next\">
                                                        <span aria-hidden=\"true\">&raquo;</span>
                                                    </a>
                                                </li>";
                            } else {
